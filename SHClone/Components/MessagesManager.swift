...
//  ChatApp
//
//  Created by jpellegrino on 1.03.2022.
//

//**inside of this func, we will call our database , then call the collection messages
//**our collection messages in firestore
